...
(function ($) {
  ...
  /*----------------------------- Site Loader & Popup --------------------*/
  // Hide overlay as soon as the DOM skeleton is ready, not waiting for all assets
  $(document).ready(function () {
    var $overlay = $("#ms-overlay");
    if ($overlay.length) {
      $overlay.fadeOut("slow");
      // Safety fallback to ensure it's gone even if animations are blocked
