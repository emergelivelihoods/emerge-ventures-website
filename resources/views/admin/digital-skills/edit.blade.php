        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="text-center">
                    <img id="image-preview" src="{{ $digitalSkill->image ? asset($digitalSkill->image) : asset('assets/img/placeholder.jpg') }}" alt="Image preview" class="w-full h-48 object-cover rounded-lg mb-4">
