...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-8 max-w-7xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-gray-600 text-lg">Create a comprehensive entrepreneur profile</p>
                    </div>
            ...
            <form action="{{ route('admin.entrepreneurs.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="bio" id="bio" rows="4" 
                            class="form-input resize-none" placeholder="Brief personal biography and background">{{ old('bio') }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="business_size" id="business_size" class="form-input">
                                ...
                                <option value="Solo entrepreneur" {{ old('business_size') == 'Solo entrepreneur' ? 'selected' : '' }}>Solo entrepreneur</option>
                                <option value="2-5 employees" {{ old('business_size') == '2-5 employees' ? 'selected' : '' }}>2-5 employees</option>
                                <option value="6-10 employees" {{ old('business_size') == '6-10 employees' ? 'selected' : '' }}>6-10 employees</option>
                                <option value="11-25 employees" {{ old('business_size') == '11-25 employees' ? 'selected' : '' }}>11-25 employees</option>
                                <option value="26-50 employees" {{ old('business_size') == '26-50 employees' ? 'selected' : '' }}>26-50 employees</option>
                                <option value="50+ employees" {{ old('business_size') == '50+ employees' ? 'selected' : '' }}>50+ employees</option>
                            </select>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <textarea name="business_description" id="business_description" rows="4" required
                                class="form-input resize-none" placeholder="Describe what your business does">{{ old('business_description') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="business_preview" id="business_preview" rows="4" 
                                class="form-input resize-none" placeholder="Short preview for business cards (optional)">{{ old('business_preview') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="overview" id="overview" rows="5" 
                            class="form-input resize-none" placeholder="Comprehensive overview for the profile page">{{ old('overview') }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <textarea name="value_proposition" id="value_proposition" rows="3"
                                class="form-input resize-none" placeholder="What unique value does your business provide?">{{ old('value_proposition') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="five_year_plan" id="five_year_plan" rows="3"
                                class="form-input resize-none" placeholder="Where do you see your business in 5 years?">{{ old('five_year_plan') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="achievements" id="achievements_hidden">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="partners" id="partners_hidden">
                ...
                <div class="form-section">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="url" name="social_media[facebook]" id="facebook" value="{{ old('social_media.facebook') }}"
                                class="form-input" placeholder="https://facebook.com/yourpage">
                        </div>
                        <div>
                            <label for="twitter" class="form-label">Twitter</label>
                            <input type="url" name="social_media[twitter]" id="twitter" value="{{ old('social_media.twitter') }}"
                                class="form-input" placeholder="https://twitter.com/youraccount">
                        </div>
                        <div>
                            <label for="linkedin" class="form-label">LinkedIn</label>
                            <input type="url" name="social_media[linkedin]" id="linkedin" value="{{ old('social_media.linkedin') }}"
                                class="form-input" placeholder="https://linkedin.com/in/yourprofile">
                        </div>
                        <div>
                            <label for="instagram" class="form-label">Instagram</label>
                            <input type="url" name="social_media[instagram]" id="instagram" value="{{ old('social_media.instagram') }}"
                ...
                <div class="form-section">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="joined_date" id="joined_date" value="{{ old('joined_date', date('Y-m-d')) }}"
                                class="form-input">
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            setupTagInput('skills_input', 'skills_container', 'skills_hidden');
            setupTagInput('achievements_input', 'achievements_container', 'achievements_hidden');
            setupTagInput('partners_input', 'partners_container', 'partners_hidden');
        });
    </script>
</body>
</html>